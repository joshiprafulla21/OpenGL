...
#include<math.h>
#include<gl/GLU.h>
#pragma comment(lib,"opengl32.lib")	// To link with OpenGL lib=> for linker
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	wndclass.style = CS_VREDRAW | CS_HREDRAW | CS_OWNDC; //CS_OWNDC => don't discard this handle of this dc
...
void resize(int width, int height)
{
	if (height == 0)
		height = 1;
	//glViewport((GLint)width / 4, (GLint)height / 4, (GLsizei)width/2, (GLsizei)height/2);
...
void DrawCircle()
{
	...
	{
		dAngle = 2 * PI * i / NumberOfPoints;
		glColor3f(1.0f, 1.0f, 0.0f);
		glVertex2f(fRadius*cos(dAngle), fRadius*sin(dAngle));
		//glVertex2f(cos(dAngle), sin(dAngle));
