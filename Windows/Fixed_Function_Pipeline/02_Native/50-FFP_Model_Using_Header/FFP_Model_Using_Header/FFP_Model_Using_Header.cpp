...
void update(void)
{
	...
	if (angleTeapot >= 360.0f)					//This snippet is for continuous rotation of rectangle
		angleTeapot = 0.0f;
}
...
void display(void)
{
	...
	glRotatef(-90.0f, 0.0f, 1.0f, 0.0f);	// imp call to set Y axis of ready-made model
