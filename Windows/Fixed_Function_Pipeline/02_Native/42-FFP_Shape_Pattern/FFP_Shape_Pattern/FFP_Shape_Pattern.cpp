...
void display(void)
{
	...
	void Draw_First_Shape(void);
	void Draw_Second_Shape(void);
	void Draw_Third_Shape(void);
	void Draw_Fourth_Shape(void);
	void Draw_Fifth_Shape(void);
	void Draw_Sixth_Shape(void);
...
void Draw_First_Shape()
{
	...
	/* ALL VALUES ARE GIVEN ROW-WISE AND FROM LEFT TO RIGHT */
	//FIRST ROW
	glVertex3f(-0.375f, 0.375f, 0.0f);
	glVertex3f(-0.125f, 0.375f, 0.0f);
	glVertex3f(0.125f, 0.375f, 0.0f);
...
void Draw_Second_Shape()
{
	...
	/*-------- DIAGONAL LINES FORM RIGHT BOTTOM TO LEFT TOP ----------*/
	//1st Disgonal
	glVertex3f(0.125f, -0.375f, 0.0f);
	glVertex3f(0.375f, -0.125f, 0.0f);
