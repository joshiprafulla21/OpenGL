...
GLfloat Identity_Matrix[16];		// Declaration of Identity MAtrix
GLfloat Translate_Matrix[16];		// Declaration of Translate MAtrix
GLfloat Rotate_Matrix[16];			// Declaration of Rotate MAtrix
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("FFP_Triangle_Spinning_Without_glRotate()!!"),
...
int initialize(void)
{
	...
	/**** PIECE-MEAL INITIALIZATION OF IDENTITY MATRIX ****/
	/*ALL MATRIX ARE COLUMN MAJOR HENCE INITIALIZATION IS DONE COLUMN-WISE*/
	// 1st COLUMN
	...
	/**** PIECE-MEAL INITIALIZATION OF TRANSLATE MATRIX ****/
	/*ALL MATRIX ARE COLUMN MAJOR HENCE INITIALIZATION IS DONE COLUMN-WISE*/
	// 1st COLUMN
	...
	// 4th COLUMN
	Translate_Matrix[12] = 0.0f;
	Translate_Matrix[13] = 0.0f;
	Translate_Matrix[14] = -6.0f;
...
void display(void)
{
	...
	glLoadMatrixf(Identity_Matrix);		//THIS CALL IS SAME AS glLoadIdentity();..Identity_Matrix is initialized above warm-up call
	glMultMatrixf(Translate_Matrix);	// THIS CALL IS SAME AS glTranslatef(0.0f, 0.0f, -6.0f);..Translate_Matrix is initialized above warm-up call

	/**** PIECE-MEAL INITIALIZATION OF Y-ROTATION MATRIX ****/
	/*ALL MATRIX ARE COLUMN MAJOR HENCE INITIALIZATION IS DONE COLUMN-WISE*/
	// 1st COLUMN
	Rotate_Matrix[0] = cos(dAngle);
	Rotate_Matrix[1] = 0.0f;
	Rotate_Matrix[2] = -sin(dAngle);
	Rotate_Matrix[3] = 0.0f;
	// 2nd COLUMN
	Rotate_Matrix[4] = 0.0f;
	Rotate_Matrix[5] = 1.0f;
	Rotate_Matrix[6] = 0.0f;
	Rotate_Matrix[7] = 0.0f;
	// 3rd COLUMN
	Rotate_Matrix[8] = sin(dAngle);
	Rotate_Matrix[9] = 0.0f;
	Rotate_Matrix[10] = cos(dAngle);
	...
	glMultMatrixf(Rotate_Matrix);		// THIS CALL IS SAME AS glRotatef(dAngle, 0.0f, 1.0f, 0.0f);
	dAngle = dAngle + 0.005f;
	if (dAngle >= 360.0f)				//This snippet is for continuous rotation of triangle
		dAngle = 0.0f;
