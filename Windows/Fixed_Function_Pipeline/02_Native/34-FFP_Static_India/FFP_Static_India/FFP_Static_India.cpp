...
void Draw_First_I()
{
	...
	// Below code is for lower horizontal line of I
	//glColor3f(0.0705882f, 0.5333333f, 0.02745098f);			// Green color, RGB values taken from wiki
	//glVertex3f(-0.07f, -0.7f, 0.0f);

	//glColor3f(0.0705882f, 0.5333333f, 0.02745098f);			// Green color, RGB values taken from wiki
	//glVertex3f(0.07f, -0.7f, 0.0f);
	// Lower horizontal line of I ends here
	// 'I' rendered here
