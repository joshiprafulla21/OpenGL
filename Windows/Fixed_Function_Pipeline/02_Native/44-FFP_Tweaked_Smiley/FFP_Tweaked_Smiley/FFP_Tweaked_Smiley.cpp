...
void display(void)
{
	...
	if (pressedDigit == 1)		// Bottom Left Corner
	{
	...
	else if (pressedDigit == 3)		//  Tiles of 4
	{
		glBegin(GL_QUADS);
	...
	else if (pressedDigit == 4)		// Show only centre of texture
	{
		glBegin(GL_QUADS);
		glTexCoord2f(0.5f, 0.5f);
		glVertex3f(1.0f, 1.0f, 0.0f);
	...
	else							// If anything else, then set to white
	{
		glBegin(GL_QUADS);
