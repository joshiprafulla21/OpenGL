...
void display(void)
{
	...
	glLineWidth(3.0f);
	int count = 0;
	for (float Size = 0.0f; Size <= 1.0f; Size = Size + 0.1f)
	{
		count++;
		DrawTriangles(Size, count);
	}
	//DrawTriangles();
...
void DrawTriangles(float Size, int count)
{
